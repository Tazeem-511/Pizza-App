          ...
          <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
              <div class="overflow-hidden">
                {state.length > 0 ? (
                  <>
                    <table class="min-w-full text-left text-lg font-light cart-con">
                    ...
                    <div>
                      <h1 className="font-bold my-2 total-price">
                        {" "}
                    ...
                    <button
                      ...
                      className="border dark:border-gray-400 border-gray-900 rounded p-2   cart-btn"
                    >
                      Check Out
                    </button>
                  </>
                ) : (
                  <div className="font-semi text-center text-4xl text-white">
                    Your cart is empty 😕{" "}
                  </div>
                )}
              </div>
